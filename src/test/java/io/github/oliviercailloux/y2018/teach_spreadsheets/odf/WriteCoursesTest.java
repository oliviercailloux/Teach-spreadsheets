...
public class WriteCoursesTest {
	...
	public void testWriteCoursesOfYear() throws Exception {
		...
		Course course1 = new Course("Analyse1", "A1DEM01", sheetName,
				"Simenhaus", "Legendre" + "Lamboley" + "Attouchi" + "Simenhaus"
						+ "Boussion" + "Truchot",
				1);
		...
		Course course2 = new Course("Algèbre linéaire 1", "A1DEM02", sheetName,
				"Pasquignon", "Tamzali-Lafond" + "Henon" + "Pasquignon"
						+ "Taleng" + "Pasquignon" + "Vialard",
				1);
		course2.setCMTD_Hour(72);
		course2.setGrpsNumber("6 CMTD");

		Course course3 = new Course("Algorithmique et programmation 1",
				"A1DEM03", sheetName, "Colazzo", "Colazzo CM" + "Raksanyi"
						+ "Gabrel-Willemin" + "Murat" + "Manouvrier" + "Arib",
				1);
		...
		Course course6 = new Course("Problèmes économiques", "A1DEM06",
				sheetName, "Dieudonne", "Dieudonne", 1);
		...
		Course course5 = new Course("Anglais 1", "A1DEM05", sheetName,
				"Bourrel", "Lytle-Hassan" + "Countcham" + "Joyce" + "Roque"
						+ "Pattie" + "Whiteside" + "Levy-Alimi",
				1);
		course5.setCMTD_Hour(18);
		course5.setGrpsNumber("12");

		Course courseL = new Course("LV2 (Allemand / Espagnol)",
				"A1ALL01" + "A1ESP01", sheetName, "Quinchon-Caudal" + "Amisse",
				"Tudoran" + "Barrera Guarin" + "Jareno Gila", 1);
		...
		Course course9 = new Course("Algèbre linéaire 2", "A1DEM09", sheetName,
				"Vialard", "Vialard CM" + "Rammal" + "Fu Ying" + "Coron"
						+ "Macasieb" + "Schaison" + "Fu",
				1);
		...
		Course course11 = new Course("Algorithmique et programmation 2",
				...
				"Cazenave CM" + "Jamain" + "Pontoizeau" + "Ternier" + "Labernia"
						+ "Haddad" + "Tlilane",
				1);
		...
		Course course14 = new Course(
				"Outils en informatique" + "- Outils de l'internet", "A1DEM14",
				sheetName, "Mayag",
		...
		Course course141 = new Course("Outils en informatique"
				...
				"A1DEM14", sheetName, "Mayag", "Mayag CM" + "Belhoul" + "Jamain"
						+ "Magnouche" + "Mouhoub" + "Haddad",
				1);
		...
		Course course142 = new Course(
				"Outils en informatique" + "- Bases de données élémentaires",
				"A1DEM14", sheetName, "Mayag",
				"Mayag CM" + "Belhoul" + "Fu Liangliang" + "Monnet" + "Arib",
				1);
