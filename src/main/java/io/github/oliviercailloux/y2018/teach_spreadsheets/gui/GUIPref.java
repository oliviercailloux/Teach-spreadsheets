...
public class GUIPref {
	public static void main(String[] args) {
		...
		buttonSubmit.addSelectionListener(new SelectionAdapter() {
			...
			// @Override
			/*
			 * public void widgetSelected(SelectionEvent event) { try {
			 * createPref(); } catch (ValidationException e) {
			...
			/*
			 * private void createPref() { List<CoursePref> prefs = new
			 * ArrayList<CoursePref>();
			 * 
			 * }
			 */
		});
