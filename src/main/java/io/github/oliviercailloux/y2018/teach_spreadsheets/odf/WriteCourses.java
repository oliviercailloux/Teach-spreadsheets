...
public class WriteCourses {
	...
	private int yearBegin = 0, yearEnd = 0, studentsNumber = 0, firstSemesterNumber = 1;
	...
	WriteCourses(File excelFile, String completeYearOfStudyName, int yearBegin, int yearEnd, int studentsNumber,
			int firstSemesterNumber, ArrayList<Course> firstSemester, ArrayList<Course> secondSemester)
			throws Exception {
	 ...
	 * @throws Exception
	 */
	private void WriteSemesterCourses(ArrayList<Course> coursesList, int col, int line) throws Exception {
	...
	public void setFirstSemesterCourses(ArrayList<Course> firstSemesterCourses) {
	...
	public void setSecondSemesterCourses(ArrayList<Course> secondSemesterCourses) {
