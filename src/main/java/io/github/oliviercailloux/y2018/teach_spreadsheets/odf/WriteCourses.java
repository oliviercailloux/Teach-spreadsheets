...
public class WriteCourses {
	 ...
	 */
	public WriteCourses(InputStream source, OutputStream destination,
	...
	public void writeCoursesOfYear() throws Exception {
		...
		writeSemesterCourses(courseSheet.getCourses(1), STARTCOLUMN1,
				STARTROW1);
		writeSemesterCourses(courseSheet.getCourses(2), STARTCOLUMN2,
				STARTROW2);
	}
	...
	private void writeHeader(Font headerBoldFont, Font headerFont,
		...
		sheet.getCellByPosition("B1")
				.setStringValue(courseSheet.getCompleteYearOfStudyName());
		...
		sheet.getCellByPosition("J1").setStringValue(
				": " + courseSheet.getStudentNumber() + " étudiants");
		...
		sheet.getCellByPosition("B2").setStringValue("ENSEIGNEMENTS SEMESTRE "
				+ courseSheet.getFirstSemesterNumber());
		...
		sheet.getCellByPosition("P2").setStringValue("ENSEIGNEMENTS SEMESTRE "
				+ (courseSheet.getFirstSemesterNumber() + 1));
