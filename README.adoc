...
* Faire une documentation sur le programme existant, feuilles en entrée, feuilles en sortie, analyser ce que fait le programme ; une documentation qui pourra être utile et compréhensible par un utilisateur. 
