...
* Trouver une solution qui permettrait au programme de se connecter directement à Internet et de s'authentifier automatiquement, ce qui permettra également d'automatiser les tests.
