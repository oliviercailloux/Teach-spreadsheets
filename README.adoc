...
* Continuer la link:https://github.com/oliviercailloux-org/dep-git-Teach_spreadsheets/pull/28[PR #28] et fournir une documentation afin de permettre l'automatisation des tests pour le groupe de l'année prochaine. 
