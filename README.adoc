...
== Plan Itération 4 JAVA

'''

*SMPO : Elena SOCOLOVA*

Le but de cette itération est surtout de consolider ce qu'on avait fait durant tout ce projet et ne pas rajouter de nouvelles fonctionnalités 

'''

*Team 1 : Nael et Samba*

* Créer une exeception WriteException lancer par les Classes OnlineWorksheetWriter OsdWorksheetWriter -> 1 tâche
* Faire les changements pour pouvoir merge la classe WorksheetWriter et les classes qui l'implémentent (OnlineWorksheetWriter et OdsWorksheetWriter) -> 2 tâches
* Faire les changements pour pouvoir merge la classe Authenticator
* Faire les changements pour pouvoir merge la classe WorksheetReader


'''
*Team 2 : Ryan & Mohamed Alassaf*

* Faire les changements pour pouvoir merge la classe AssignementPerTeacher


'''
*Team 3 : Mehdi & Mohamed Irazzi*

* Faire les changements pour pouvoir merge la classe XlsSummarizer

== Plan Itération 6 UML
...
*Team 1 : Samba et Ryan*

* Mettre à jour le tutoriel sur le répertoire distant et adapter le code à une utilisation simple (le séparer du projet)


'''
*Team 2 : Nael & Mehdi*

* Refaire le diagramme de classe interface et classes implémenté PR #33


'''
*Team 3 : Mohamed Irazzi & Mohamed Alassaf*

* Faire un diagramme de séquence avec une documentation si nécessaire du processus d’exécution de la sixième fonctionnalité à envisager c'est à dire "l’application génère un résumé de toutes les affectations, par cours, pour diffusion aux enseignants".
