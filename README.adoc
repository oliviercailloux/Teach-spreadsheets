...
*Team 1 : Mohammed I & Ryan*

* Continuer de travailler sur la PR #17, nous allons implémenter les tests unitaires pour l'écriture en ligne relatifs à la classe AssignmentPerTeacher.

* Nous allons prendre en considération les remarques faîtes afin d'améliorer le code existant (implémentation du logger).
...
* Comme expliqué à la PR #16, la modification du style ou de la police d'une cellule ne fonctionne pas, en effet lorsque l'on souhaite modifier le style d'une cellule, ce sont toutes les cellules qui sont modifiées. Nous allons donc retravailler sur ça en partant de la nouvelle version de Microsoft 365 qui va être implémentée.
