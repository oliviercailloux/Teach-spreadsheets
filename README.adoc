...
* Continuer la tâche faîtes lors de la link:https://github.com/oliviercailloux-org/dep-git-Teach_spreadsheets/pull/16[PR #16] , dans la classe XlsSummarizer implémenter les fonctions permettant de remplir les colonnes restantes.
